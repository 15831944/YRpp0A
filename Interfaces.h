...
ILocomotion : IUnknown
{
	...
	virtual Matrix3DStruct::TransformMatrix* __stdcall Draw_Matrix(Matrix3DStruct::TransformMatrix* pMatrix, int* key) = 0; //virtual Matrix3DStruct* __stdcall Draw_Matrix(Matrix3DStruct* pMatrix, int* key) = 0; //Fetch voxel draw matrix.
	virtual Matrix3DStruct::TransformMatrix* __stdcall Shadow_Matrix(Matrix3DStruct::TransformMatrix* pMatrix, int* key) = 0;	//Fetch shadow draw matrix.
