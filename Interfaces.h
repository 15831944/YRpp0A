...
ILocomotion : IUnknown
{
	...
	virtual TransformMatrix* __stdcall Draw_Matrix(TransformMatrix* pMatrix, int* key) = 0; //virtual Matrix3DStruct* __stdcall Draw_Matrix(Matrix3DStruct* pMatrix, int* key) = 0; //Fetch voxel draw matrix.
	virtual TransformMatrix* __stdcall Shadow_Matrix(TransformMatrix* pMatrix, int* key) = 0;	//Fetch shadow draw matrix.
